...
import com.emily.rest.webservices.restfulwebservices.user.UserNotFoundException;

@ControllerAdvice
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    
    @ExceptionHandler(Exception.class) //define what kind of exception we are going to handle
    ...
    @ExceptionHandler(UserNotFoundException.class) //define what kind of exception we are going to handle
